    ...
    <section class="ab-info-main py-md-5 py-5">
        <div class="container">
            <div class="inner-sec-w3pvt py-lg-5">
                <h3 class="tittle text-center mb-lg-5 mb-3 inner-tittle"><span class="sub-tittle"></span>Register</h3>
                ...
                <div class="contact-form mt-md-5">
                    <div class="contact-form-inner mx-auto text-left">
                        <form name="contactform " id="contactform" action="./register" method="post" onsubmit="return checkAll()">
                            <div class="row">
                                <div class="col-lg-6 con-gd">
                                    <div class="form-group">
                                        <label>AccountID</label>
                                        <input type="text" class="form-control" name="userID" id="userID" margin="10" onblur="checkUser()" placeholder="Enter AccountID">
                                        <span id="userIDspan" style="display: block"></span>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Your first name</label>
                                        <input type="text" class="form-control" name="fName" id="fName" maxlength="15" placeholder="Enter First Name" onblur="checkFname()">
                                        <span id="fNamespan"style="display: block"></span>
                                    </div>
                                     <div class="form-group">
                                        <label>Your last name</label>
                                        <input type="text" class="form-control" name="lName" id="lName" maxlength="15" placeholder="Enter Last Name" onblur="checkLname()">
                                        <span id="lNamespan"style="display: block"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Set your Tel</label>
                                        <input type="text" class="form-control" id="userTel" maxlength="30" placeholder="Enter Tel" name="userTel" onblur="checkTel()">
                                        <span id="userTelspan"style="display: block" ></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Set your Address</label>
                                        <input type="text" class="form-control" id="address" maxlength="30" placeholder="Enter Address" name="address" onblur="checkAddress()">
                                ...
                                <div class="col-lg-6 con-gd">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" class="Wdate" name="DoB" onFocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d',readOnly:true})" placeholder="Select Birthday" >
                                    </div>
                                    <div class="form-group">
                                        <label>Set your password</label>
                                        <input type="password" class="form-control" id="password" placeholder="password" name="password" onblur="checkPassword()" onfocus="javascript:if(this.value == '6 characters or letters at least')this.value=''">
                                        <span id="passwordspan"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Confirm your password</label>
                                        <input type="password" class="form-control" id="confirmpassword" placeholder="password" name="confirmpassword" onblur="checkSame()">
                                        <span id="confirmpasswordspan"style="display: block"></span>
                                    </div>
                                    <div style="padding: 32px 70px">
                                    <button type="submit" class="btn btn-default" id="register" name="regisOrChange" value="Submit" style="width:220px">Submit</button>
                                    </div>
                                </div>
                            </div>
