...
<title>Contact</title>
    ...
    function checkSubject() {
		...
		var spanNode = document.getElementById("subjectspan");
		var reg = /^([a-zA-Z0-9])+$/i;
		if (reg.test(subject)) {
			spanNode.innerHTML = "".fontcolor("green"); 
			return true;
		} else {
			spanNode.innerHTML = "Invalid subject, try again!".fontcolor("red");   
			return false;
		}
	}
	function checkContent() {
		...
		if (reg.test(content)) {
			...
			spanNode.innerHTML = "Invalid content, try again!".fontcolor("red");   
			return false;
		}
	}
	function checkAll() {
		var sub = checkSubject();
		var con = checkContent();
		if (sub && con) {
			return true;
		} else {
			return false;
    ...
    <section class="ab-info-main py-md-5 py-5">
        <div class="container">
            <div class="inner-sec-w3pvt py-lg-5">
                <h3 class="tittle text-center mb-lg-5 mb-3 inner-tittle"> My Blog</h3>
                <p class="text-center px-lg-5" data-aos="fade-up">All the beautiful things in life are worth remembering. Every time I accompany with Natum products, I feel happy. What's your story with Natum?Welcome to communicate with you.</p>
                <div class="contact-form mt-md-5">
                    <div class="contact-form-inner mx-auto text-left">
                        <form name="contactform " id="contactform" action="./post" method="post" onsubmit="return checkAll()">
                            <div class="form-group">Username: <%=(String)session.getAttribute("username") %></div>
                            
                            <div class="form-group">
                                <label>Subject</label>
                                <textarea name="subject" class="form-control" id="subject" onblur="checkSubject()" placeholder="Enter Your Message Here"></textarea>
                                <span id="subjectspan"></span>
                                <br>
                                <label>Content</label>
                                <textarea name="content" class="form-control" id="content" onblur="checkContent()" placeholder="Enter Your Message Here"></textarea>
                                <span id="contentspan"></span>
                            </div>
                            <button type="submit" class="btn btn-default"><input type="SUBMIT" name="submit" value="Submit" style="background-color: transparent;border:0;color:white"></button>
                        </form>
