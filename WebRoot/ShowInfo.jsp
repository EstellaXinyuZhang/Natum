    ...
    <section class="ab-info-main py-md-5 py-5">
        <div class="container">
            <div class="inner-sec-w3pvt py-lg-5">
                <h3 class="tittle text-center mb-lg-5 mb-3 inner-tittle"><span class="sub-tittle"></span>Personal Information</h3>
                ...
                <div class="contact-form mt-md-5">
                    <div class="contact-form-inner mx-auto text-left">
                        <form name="contactform " id="contactform" action="ChangeInfo.jsp" method="post">
                        
                            <div class="row">
                                <div class="col-lg-6 con-gd">
                                    <div class="form-group">
                                        <label>AccountID</label>
                                        <input readonly="readonly" type="text" class="form-control" name="userID" id="userID" margin="10" value="<%=user.getUsername() %>" name="AccountID" / >
                                        
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Your first name</label>
                                        <input readonly="readonly" type="text" class="form-control" value="<%=user.getFname()%>"  maxlength="15" id="fName" name="fName" />
                                    </div>
                                     <div class="form-group">
                                        <label>Your last name</label>
                                        <input readonly="readonly" type="text" class="form-control" value="<%=user.getLname()%>" width="20%" maxlength="15" id="lName" name="lName"/>
                                     </div>
                                    <div class="form-group">
                                        <label>Set your Tel</label>
                                        <input readonly="readonly" type="text" class="form-control" value="<%=user.getPhonenumber()%>" maxlength="30" name="userTel" id="userTel" name="userTel"/>
                                    </div>
                                ...
                                <div class="col-lg-6 con-gd">
                                    <div class="form-group">
                                        ...
                                        <input readonly="readonly" type="text" class="form-control" value="<%=user.getAddress()%>" maxlength="30" id="address" name="address"  />
                                    </div>
                                    <div style="height: 96.7px">
                                        <label>Gender</label>
                                        <input readonly="readonly" type="text" class="form-control" value="<%=user.getSex()%>" width="20%" maxlength="15">
                                    </div>
                                    <div class="form-group">
                                        <label>Date of birth</label>
                                        <input readonly="readonly" type="text" class="form-control" value="<%=user.getDob()%>" name="DoB">
                                        
                                    </div>
                                    
                                    <div style="padding: 32px 70px">
                                        <button type="submit" id="register" value="Change My Information" class="btn btn-default" style="width:220px">Change My Info</button>
                                    </div>
                                </div>
                            </div>
